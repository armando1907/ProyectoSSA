     ...
     <table class="table table-striped tabladatatable dt-responsive">
        ...
        <tbody>
          <?php
            $item=null;
            $valor = null;
            $usuarios = ControladorUsuarios::ctrM2($item, $valor);
          ...
          <th><button class="btn btn-secondary btn-xs btnVerAlumno" idAlumno="'.$value["id_alumno"].'" data-toggle="modal" data-target="#modalVerAlumno"><i class="fas fa-user-edit"></i></button>
          ...
          <form role="form" method="post" enctype="multipart/form-data">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <div class="form-group">
                  <div class="input-group">
                    <select class="form-control input-lg" name="codigo" id="codigo" readonly>
