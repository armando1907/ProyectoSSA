   ...
   .hyperspan
{
  ...
  <div class="content-wrapper">
          ...
          <div class="card-body text-secondary">
            ...
            <div class="row">
              ...
              echo '<img src="'.$_SESSION['foto'].'" class="img-thumbnail" width="150px">';
                ...
                <div class="row ">
                  <div class="col-sm-12"><?php echo '<h4><b>Nombre del Administrador:</b> '.$_SESSION['nombre'].' '.$_SESSION['aPaterno'].' </h4>'?></div>
                </div>
                <div class="row ">
                  <div class="col-sm-12"><?php echo '<h4><b>Código del Administrador:</b> '.'IPR-'."RSSA-"."".$_SESSION['id'].' </h4>'?></div>
                </div>
                <div class="row ">
                  <div class="col-sm-12"><?php echo '<h4><b>Administrador:</b> Estatal</h4>'?></div>
                </div>
                </div>
              </div>
            </div>
    ...
    <form action=modelos/exceladmin.php method="post">
   <input type="hidden" name="J1" id="" value="all">
            ...
            <div class="small-box bg-success">
              <div class="inner">
                <?php   
                    $item=null;
                    $valor = null;
                    $cursos = ControladorCursos::ctrMostrarInstitucionalesAdm($item, $valor); 
                    $count = count($cursos);
                    echo'<h3>'.$count.'</h3>' ?>
                <p>Cursos Publicos</p>
                <a href="cursosins"> 
            ...
            <div class="small-box bg-danger">
              <div class="inner">
                <?php   
                    $item=null;
                    $valor = null;
                    $usuarios = ControladorUsuarios::ctrM($item, $valor); 
                    $count = count($usuarios);
                    echo'<h3>'.$count.'</h3>' ?>
